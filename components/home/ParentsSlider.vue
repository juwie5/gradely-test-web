<template>
    <section class="parent-slider">
        <section class="parent-slider__container">
            <div v-for="item in items" :key="item">
                <div class="rounded-[10px]  cursor-pointer w-[90%] flex flex-col justify-between"
                    :class="[parents ? 'border border-[#E5E5E5] p-4' : 'border-none p-2 w-full']"
